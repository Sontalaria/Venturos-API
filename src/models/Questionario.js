...
export default (sequelize) => {
  const Questionario = sequelize.define(
    "Questionario",
    {
      ...
      idades_criancas: { type: DataTypes.JSON, allowNull: true }, // array
      residencia_tipo: { type: DataTypes.STRING, allowNull: false }, // própria ou alugada
      proprietario_permite_animais: { type: DataTypes.BOOLEAN, allowNull: true },
      ...
      animais_que_ja_criou: { type: DataTypes.TEXT, allowNull: true },
      destino_animais_anteriores: { type: DataTypes.TEXT, allowNull: true },
      ...
      veterinario_usual: { type: DataTypes.STRING, allowNull: true },
      forma_de_educar: { type: DataTypes.STRING, allowNull: true },
